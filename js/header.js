...
"			<ul class='navbar-nav mr-auto row align-items-center text-center text-uppercase'>" +
...
"				<li class='nav-item col-md-2'><a class='link' href='http://localhost:3000/#/list' id='nav-hour'>Login/Sign Up</a></li>" +
"			</ul>" +
"		</nav>" +
"	</div>" +
"</nav>"
