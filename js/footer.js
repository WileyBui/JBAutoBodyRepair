...
"				<ul>" +
"					<li><strong>Jackson Bui</strong></li>" +
"				</ul>" +
"				<a href='tel:612-806-5584' class='text-dark'>(612) 806-5584</a><br>" +
"				<a href='mailto:jackbui17@gmail.com' class='text-dark' target='_blank'>JacksonBui17@gmail.com</a>" +
"			</div>" +
...
"				<h5 class='text-uppercase font-weight-bold'>Hours (<font color='#4DF11B'>Auto</font> | <font color='#E7263B'>Towing</font>)</h5>" +
"				<ul>" +
"					<li><strong>Mon-Fri</strong>: <font color='#4DF11B'>9:00AM-6:00PM</font> | <font color='#E7263B'>9:00AM - 10:00PM</font></li>" +
"					<li><strong>Sat</strong>: <font color='#4DF11B'>9:00AM-1:00PM</font> | <font color='#E7263B'>9:00AM - 6:00PM</font></li>" +
"					<li><strong>Sun</strong>: <font color='#4DF11B'>Closed</font> | <font color='#E7263B'>Closed</font></li>" +
"				</ul>" +
"			</div>" +
"		</div>" +
"	</div>" +
